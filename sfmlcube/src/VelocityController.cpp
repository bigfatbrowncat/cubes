...
namespace sfmlcubes
{
	...
	float VelocityController::ROTATION_LONGITUDE_START = 0.3;
	float VelocityController::FALLING_DOWN_LONGITUDE_START = 0.1;
	float VelocityController::FALLING_DOWN_FAST_LONGITUDE_START = 0.04;
	float VelocityController::HORIZONTAL_MOVING_LONGITUDE_START = 0.09;

	// And these are the limits for "infinity" speed.
	float VelocityController::ROTATION_LONGITUDE_LIMIT = 2;
	float VelocityController::FALLING_DOWN_LONGITUDE_LIMIT = 0.95;
	float VelocityController::FALLING_DOWN_FAST_LONGITUDE_LIMIT = 0.5;
	float VelocityController::HORIZONTAL_MOVING_LONGITUDE_LIMIT = 1;
