...
namespace sfmlcubes
{
	...
	namespace widgets
	{
		...
		public:
			...
			Coordinates fromCubeInShapeCoordsToFieldCoords(const sf::Vector2u& targetSize, const Shape& shape, const CubeCoordinates& currentCubeCoords, const Coordinates& coordsInTheCubeSpace) const;
